...
export Grid, make_grid, valid_position,
       ...
       stress, normalise_matrix, stress_if_moved,
       swarm_epoch!, swarm_radius!,
       PswarmResult, pswarm!, pswarm_live!,
       projection_data, umatrix,
...
function swarm_epoch!(swarm::Swarm,
    ...
    return (n_jumped, stress(D_data, D_grid))
end
...
Run the full DatabionicSwarm on a pairwise distance matrix.
